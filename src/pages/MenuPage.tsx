...
export function MenuPage({ weeklyMenu, onBack, onOpenCart, onOpenRations, onOpenRecipe, onRemoveRecipe, onAddManualMeal, onAddAiMeal }: MenuPageProps) {
