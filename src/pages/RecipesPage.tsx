    ...
    <section className="flex flex-1 flex-col">
      ...
      <div className="sticky top-0 z-10 -mx-4 mt-5 bg-[#FFFDF8] px-4 pb-3 pt-1">
        <label className="block">
          ...
          <input
            className="w-full rounded-2xl border border-[#92735C]/35 bg-white px-4 py-3 text-base font-semibold text-[#30360E] shadow-sm outline-none transition placeholder:text-[#92735C] focus:border-[#92735C]/35 focus:ring-4 focus:ring-[#EEF1D8]"
            ...
            <button
              className={`shrink-0 rounded-full px-4 py-2 text-sm font-extrabold transition ${
                activeMealType === mealType
                  ? 'bg-[#686F12] text-white shadow-lg shadow-[#E2D4B9]/70'
                  : 'bg-white text-[#92735C] shadow-sm shadow-[#E2D4B9]/70 hover:text-[#30360E]'
              }`}
      ...
      {filteredRecipes.length === 0 && (
        <div className="mt-8 rounded-3xl bg-[#FFFDF8] p-6 text-center shadow-sm shadow-[#E2D4B9]/70">
          ...
          <button className="mt-5 rounded-2xl bg-[#686F12] px-5 py-3 text-base font-black text-white shadow-lg shadow-[#E2D4B9]/70 transition hover:bg-[#30360E]" onClick={resetFilters} type="button">
            Сбросить фильтры
          </button>
        </div>
      )}
